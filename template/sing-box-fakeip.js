...
const groups = [
  ...
  selectorGroup('Apple', ['DIRECT', ...appleRegionOrder, '全部节点'], 'DIRECT'),
  ...
  selectorGroup('AI', [...aiRegionOrder, '全部节点'], aiRegion),
  selectorGroup('Linuxdo', finalMembers, defaultRegion),
  selectorGroup('Emby', [...embyRegionOrder, '全部节点', 'DIRECT'], embyRegion),
